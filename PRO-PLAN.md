...
4. **Free: Gutenberg design abilities** (decided 2026-07-03) — the tree engine's Gutenberg profile + block-tree tools, list/get-block-schema from the registry, theme.json tokens, list/insert block patterns. Mostly reuse.
